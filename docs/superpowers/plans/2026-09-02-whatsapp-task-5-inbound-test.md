# Task 5, step 1: the test file

The full contents of `server/test/whatsapp-inbound.test.ts`. It lives beside
[task 5](2026-09-02-whatsapp-task-5-inbound.md) so that neither file crosses the
five-hundred-line limit this repository keeps for documents people maintain.

Create `server/test/whatsapp-inbound.test.ts`:
