...
Return JSON only, for example: {"classification":{"value":"customer","reason":"Клиент уточняет условия доставки."},"proposals":[{"path":"База знаний/Доставка","body":"...","sources":["message-id"],"warnings":[]}]}.`;
